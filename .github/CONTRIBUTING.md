...
> This template includes writing instructions and boilerplate text that you can customize, use as-is, or completely replace with your own text.
> This text is indicated in ```{curly braces}```. Make sure you replace the placeholders with your own text.
